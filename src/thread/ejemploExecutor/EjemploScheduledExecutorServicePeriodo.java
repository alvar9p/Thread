    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Future<?> future = executor.scheduleAtFixedRate(() -> {
            ...
            try {
                ...
                // lock.countDown();
                contador.getAndDecrement(); // decrementamos cada vez que se ejcuta una tarea
        ...
        // lock.await(); // Bloquea hasta que llega a 0
        // future.cancel(true); // Cancela cuando llega a 0
